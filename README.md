...
[![Build Status](https://travis-ci.org/andersonluizpereira/jhipstervuejsh2mssql.svg?branch=master)](https://travis-ci.org/andersonluizpereira/jhipstervuejsh2mssql)
...
To optimize the kerion application for production, run:
